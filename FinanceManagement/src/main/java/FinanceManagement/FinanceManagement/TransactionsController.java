...
public class TransactionsController implements Initializable {
	...
	@FXML
	private Button buttonExpenseCancel, buttonIncomeCancel, buttonIncomeSave, buttonSaveExpense, buttonTransferCancel,
			buttonTransferSave;
	@FXML
	private Button dashboardButton, buttonTransaction, buttonAccount, buttonProfile, btnLogOut;
	@FXML
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		/* Event handler for income save button */
		...
		/* Event handler for expense save button */
		...
		/* Event handler for transfer save button */
		...
		/* Event handler for the Income Cancel button */
		...
		/* Event handler for the Transfer Cancel button */
