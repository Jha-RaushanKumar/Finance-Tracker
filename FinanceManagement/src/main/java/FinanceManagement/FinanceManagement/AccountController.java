...
public class AccountController implements Initializable {
	...
	@FXML
	private Button buttonAccount, buttonAdd, buttonCancel, buttonLogout, buttonTansaction, dashboardButton, btnLogOut;
	@FXML
	private ChoiceBox<String> choiceboxType;
	@FXML
	private TextField txtAccountName, txtAmount, txtNote;
	@FXML
	private Text valAccountName, valAccountType, valAmount, valNote, txtUserName;
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		/* Event handler for the Transaction button */
